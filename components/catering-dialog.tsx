  ...
  return (
    <LazyMotion features={domAnimation}>
      <Dialog
        ...
        open={isOpen}
      >
        <DialogContent className="top-4 -translate-y-0 rounded-xl border-2 border-gray-200 bg-[#E3D6C3] shadow-2xl sm:top-[50%] sm:max-w-lg sm:-translate-y-1/2 [&>button]:hidden">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="font-medium text-sm text-white">
                      ...
                      gatherings to large celebrations, we can accommodate
                      groups of all sizes.
                    </p>
                  </div>
                </div>
