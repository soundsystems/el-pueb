    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        <DialogContent className="fixed top-4 right-4 left-4 z-50 grid w-auto max-w-lg translate-x-0 translate-y-0 gap-4 border-2 border-gray-200 bg-[#E3D6C3] p-4 shadow-2xl sm:top-[50%] sm:right-auto sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-xl sm:p-6 [&>button]:hidden">
          <DialogHeader className="-mx-4 px-4 sm:-mx-6 sm:px-6">
              ...
              <div className="rounded-xl border-2 border-[#F16D15] bg-[#F16D15] p-4 shadow-lg sm:p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="font-medium text-sm text-white">
                      <strong>Event Planning:</strong> From intimate gatherings
                      to large celebrations, we can help make your special
                      occasion memorable.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="mt-1 h-2 w-2 rounded-full bg-white" />
                    <p className="font-medium text-sm text-white">
                      <strong>Large Groups:</strong> For parties of 10+ people,
                      we can help coordinate your event needs and ensure a great
                      experience.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 rounded-lg bg-white/20 p-3">
                  <p className="font-semibold text-sm text-white">
                    <strong>Note:</strong> The "Event Booking Inquiry" option
                    will be automatically selected for you in the contact form.
                  </p>
                </div>
              </div>
            )}
              ...
              <div className="rounded-xl border-2 border-[#30C2DC] bg-[#30C2DC] px-2 py-3 shadow-lg sm:py-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="mt-1 h-2 w-2 rounded-full bg-white" />
                    <p className="font-medium text-sm text-white">
                      <strong>Special Requests:</strong> Any dietary
                      restrictions or special accommodations needed
                    </p>
                  </div>
                </div>
              </div>
          ...
          <DialogFooter className="flex justify-center pt-4">
            ...
            >
              <Button
                className="rounded-full px-10 py-3 font-semibold text-lg text-white shadow-lg outline-none transition-all duration-300 hover:bg-[#FD2821] hover:shadow-xl focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
                onClick={(event) => {
