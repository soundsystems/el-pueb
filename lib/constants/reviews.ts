...
export const reviews: Review[] = [
  {
    ...
    location: 'Centerton',
    text: 'Got off work late - they were the only Mexican spot open until 10, and boy did their team deliver. One heck of a magnificent feast, and some of the best prices around.',
    rating: 5,
  },
  {
    name: 'Toubabo Koomi',
  ...
  },
  {
    name: 'Cher Cleveland',
    location: 'Bella Vista',
    text: "We got quick service, and their menu was really large and the prices were great! We loved the salsa (and I'm picky about salsa)! For my entree I got this delicious thing I never heard of called El Torro which I highly recommend! ...We will definitely come back and will bring friends next time!",
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    location: 'Centerton',
    text: 'Food portions are a good size. Food and drink menu is good too. Friendly, courteous and attentive staff. Staff is accommodating as well. Love their homemade spicy salsa which you have to ask for with chips and salsa.',
    rating: 5,
  },
  {
    name: 'Joel McEwan',
    location: 'Rogers',
    text: "Our new go to Mexican restaurant! We've been there about 7 times. The salsa and the chips are very fresh. Very quick delivery of food and service.",
    rating: 5,
  },
  {
    name: 'Carol Karlowski',
    location: 'Rogers',
    text: 'Really enjoyed the food. Chili rellenos were great. ...The salsa was good as well and had just enough kick without being overwhelming!',
    rating: 5,
  },
];
